...
def findStartPt(chains, derived):
    ...
    for star,ZAMS_star in zip(flat_derived,flat_chains): #broad filter on big mass range only
        ...
        # Select only the long-period systems 
...
with MPIPool() as pool:
    ...
    # Save the chains 
    #np.save("data/150914/BHBH_chains_std.npy", pub.chains)
    #np.save("data/150914/BHBH_derived_std.npy", pub.derived)

    pub.chains = np.load("../data/150914/BHBH_chains_std.npy")
    pub.derived = np.load("../data/150914/BHBH_derived_std.npy") 
    ...
    # Save the chains
    np.save("../data/150914_PT/150914_chains_std_long_PT.npy", pub150914.chains)
    # np.save("../data/150914_PT/150914_derived_std_long_PT.npy", pub150914.derived)
