...
with MPIPool() as pool:
    ...
    # Save the chains
    #np.save("data/150914/BHBH_chains_sig150.npy", pub.chains)
    #np.save("data/150914/BHBH_derived_sig150.npy", pub.derived)

    pub.chains = np.load("../data/150914/BHBH_chains_sig150.npy")
    pub.derived = np.load("../data/150914/BHBH_derived_sig150.npy") 
    ...
    # Save the chains
    np.save("../data/150914_PT/150914_chains_sig150_long_PT.npy", pub150914.chains)
    # np.save("data/150914/150914_derived_sig150_long.npy", pub150914.derived)
