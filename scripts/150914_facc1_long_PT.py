...
model_kwargs = {'bhflag' : 3, 'acc_lim': 0, 'f_acc' : 1}
...
with MPIPool() as pool:
    ...
    # Save the chains
    #np.save("data/150914/BHBH_chains_facc1.npy", pub.chains)
    #np.save("data/150914/BHBH_derived_facc1.npy", pub.derived)

    pub.chains = np.load("../data/150914/BHBH_chains_facc1.npy")
    pub.derived = np.load("../data/150914/BHBH_derived_facc1.npy") 
    ...
    # Save the chains
    np.save("../data/150914_PT/150914_chains_facc1_long_PT.npy", pub150914.chains)
    # np.save("data/150914/150914_derived_facc1_long.npy", pub150914.derived)
