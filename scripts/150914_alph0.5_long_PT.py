...
model_kwargs = {'bhflag' : 3, 'acc_lim': 0, 'f_acc' : 0.5, 'alpha1' : 0.5}
...
with MPIPool() as pool:
    ...
    # Save the chains
    #np.save("data/150914/BHBH_chains_alph0.5.npy", pub.chains)
    #np.save("data/150914/BHBH_derived_alph0.5.npy", pub.derived)

    pub.chains = np.load("../data/150914/BHBH_chains_alph0.5.npy")
    pub.derived = np.load("../data/150914/BHBH_derived_alph0.5.npy") 
    ...
    np.save("../data/150914_PT/150914_chains_alph0.5_long_PT.npy", pub150914.chains)
    # np.save("data/150914/150914_derived_alph0.5_long.npy", pub150914.derived)
