...
def findStartPt(chains, derived):
    ...
    for star,ZAMS_star in zip(flat_derived,flat_chains): #broad filter on big mass range only
        ...
        if np.exp(ZAMS_star[2]) > 2e2: continue 
...
with MPIPool() as pool:
    ...
    # Save the chains
    np.save("../data/150914_PT/150914_chains_qc2_short_PT.npy", pub150914.chains)
    # np.save("data/150914/150914_derived_qc2_short.npy", pub150914.derived)
